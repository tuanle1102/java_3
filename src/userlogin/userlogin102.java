 ...
 * @author 1102l
 */
public class userlogin102 extends javax.swing.JFrame {
    ...
    public userlogin102() {
     ...
     public ArrayList<ListDanhSach> userList() {
        ...
        try {
            ...
            String query1 = "SELECT * FROM listds where maphong = 'P102';";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(userlogin102.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new userlogin102().setVisible(true);
