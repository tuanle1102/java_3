 ...
 * @author 1102l
 */
public class jfmp103 extends javax.swing.JFrame {
    ...
    public jfmp103() {
     ...
     public ArrayList<ListDanhSach> userList() {
        ...
        try {
            ...
            String query1 = "SELECT * FROM listds where maphong = 'P103';";
    ...
    private void lblthanhtoanMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblthanhtoanMouseMoved
        String url = "jdbc:sqlserver://localhost:1433;databaseName=QLCC;"
            ...
            Connection con = DriverManager.getConnection(url,username,password);
             ...
             String query1 ="select trangthai from HoaDon where maphong = 'P103'";
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery(query1);
                while (rs.next()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jfmp103.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
