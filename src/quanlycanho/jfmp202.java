 ...
 * @author 1102l
 */
public class jfmp202 extends javax.swing.JFrame {
    ...
    private void lblthanhtoanMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblthanhtoanMouseMoved
        String url = "jdbc:sqlserver://localhost:1433;databaseName=QLCC;"
            ...
            Connection con = DriverManager.getConnection(url,username,password);
             ...
             String query1 ="select trangthai from HoaDon where canho = 'P202'";
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery(query1);
                while (rs.next()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jfmp202.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
