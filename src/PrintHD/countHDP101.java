 ...
 * @author 1102l
 */
public class countHDP101 extends javax.swing.JFrame {
    ...
    public ArrayList<listHD> userList(){
        ...
        try {
            ...
            String query1 = "select HoaDon.id,maHD,time,trangthai,tienphong,tiendien,tiennuoc,tong from HoaDon inner join tongtien on HoaDon.id = tongtien.id where maphong = 'P101' ";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Font catFont = new Font(Font.MONOSPACED,18,Font.PLAIN);
        ...
        try {
            ...
            doc.add(new Paragraph("Hóa đơn 3LH"));
            doc.addTitle("HoaDon");
        ...
        TableModel model = jTable1.getModel();
                ...
                String mahd = model.getValueAt(i, 1).toString();
                String time = model.getValueAt(i,2).toString();
                String trangthai = model.getValueAt(i,3).toString();
                String tienphong = model.getValueAt(i, 4).toString();
                String tiendien = model.getValueAt(i, 5).toString();
                String tiennuoc = model.getValueAt(i, 6).toString();
                String tongtien = model.getValueAt(i, 7).toString();
            ...
            Logger.getLogger(countHDP101.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            int row = jTable1.getSelectedRow();
            String value = (jTable1.getModel().getValueAt(row, 0).toString());
            String query = "Update tongtien set tienphong = ?,tiendien = ?,tiennuoc = ?,tong = ? where id = " + value;
            PreparedStatement ps = con.prepareStatement(query);
          
            ps.setString(1, txtPhong.getText());
            ps.setString(2, txtDien.getText());
            ps.setString(3, txtNuoc.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(countHDP101.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new countHDP101().setVisible(true);
            }
        });
    }
