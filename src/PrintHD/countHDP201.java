 ...
 * @author 1102l
 */
public class countHDP201 extends javax.swing.JFrame {
    ...
    public ArrayList<listHD> userList(){
        ...
        try {
            ...
            String query1 = "select HoaDon.id,maHD,time,trangthai,tienphong,tiendien,tiennuoc,tong from HoaDon inner join tongtien on HoaDon.id = tongtien.id where maphong = 'P201' ";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        TableModel model = jTable1.getModel();
            ...
            Logger.getLogger(countHDP201.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(countHDP201.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new countHDP201().setVisible(true);
            }
        });
    }
